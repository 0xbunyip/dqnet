...
class NeuralAgent(object):
    ...
    def __init__(self, q_network, epsilon_start, epsilon_min,
        ...
        self.test_data_set = experience.Experience(self.phi_length * 2
                                            , self.image_height, self.image_width
                                            , self.phi_length, rng)
    ...
    def step(self, reward, observation):
        ...
        #NOT TESTING---------------------------
            ...
            if self.data_set.len > self.replay_start_size:
    ...
    def _choose_action(self, data_set, epsilon, cur_img, reward):
        ...
        data_set.add_experience(self.last_img, False, self.last_action, reward)
    ...
    def end_episode(self, reward, terminal=True):
        ...
        if self.testing:
            ...
            self.data_set.add_experience(self.last_img,
                                     True,
                                     self.last_action,
                                     np.clip(reward, -1, 1))
