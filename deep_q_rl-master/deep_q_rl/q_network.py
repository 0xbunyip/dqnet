...
class DeepQLearner:
    ...
    def build_network(self, network_type, input_width, input_height,
        ...
        if network_type == "nature_dnn":
            ...
            return self.build_nips_dqn(input_width, input_height,
                                           output_dim, num_frames, batch_size)
    ...
    def build_nips_dqn(self, input_width, input_height, output_dim,
                           num_frames, batch_size):

        self.network_description = 'NIPS deep Q-network'
        network = lasagne.layers.InputLayer((None, num_frames, input_height, input_width))
