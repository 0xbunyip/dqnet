...
Agent.FINAL_EXPLORATION_FRAME = 20000
...
Network.TARGET_NETWORK_UPDATE_FREQUENCY = 100
################################################
...
def get_arguments(argv):
	...
	parser.add_argument('-t', '--network-type', dest = 'network_type', default = 'bandit', type = str
