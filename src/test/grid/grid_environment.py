...
class Environment:
	...
	def train(self, agent, store_freq, ask_for_more = False):
		...
		while epoch < epoch_count:
			...
			self._update_log_files(agent, epoch + 1, epoch_count, episode
	...
	def _update_log_files(self, agent, epoch, epoch_count, episode, valid_values
		...
		if (store_freq >= 0 and epoch >= epoch_count) or \
